...
\end{justify}
\begin{center}
  \includegraphics[width=0.65\textwidth]{img/getNumber.png}
\end{center}
...
\end{justify}
\begin{center}
  \includegraphics[width=0.65\textwidth]{img/getString.png}
\end{center}
...
\end{justify}
\begin{center}
  \includegraphics[width=0.6\textwidth]{img/getComment.png}
\end{center}
...
\end{justify}
\begin{center}
  \includegraphics[width=0.45\textwidth]{img/getIdentifier.png}
\end{center}
...
\end{justify}
\begin{center}
  \includegraphics[width=0.5\textwidth]{img/getOperator.png}
\end{center}
